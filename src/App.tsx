...
export default function App() {
  ...
  const handleQuizSubmit = () => {
    if (quizAnswers.q1 === 'b' && quizAnswers.q2 === 'a' && quizAnswers.q3 === 'c') {
    ...
    case 12: return (
      <div className="h-screen bg-slate-900 flex items-center justify-center text-white p-4 relative overflow-hidden">
        ...
        <div className="bg-white text-slate-900 p-12 rounded-[3rem] text-center max-w-2xl w-full relative z-10 shadow-2xl animate-bounce-slow">
          ...
          <button onClick={() => { setStep(0); setQuizAnswers({q1:'',q2:'',q3:''}); }} className="w-full bg-slate-900 text-white py-5 rounded-2xl font-bold hover:bg-red-600 transition-colors shadow-xl">
            Reiniciar Sistema
          </button>
        </div>
        <RadioPlayer />
